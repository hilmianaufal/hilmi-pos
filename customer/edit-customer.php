...
$id = $_GET['id'];
$sqlCustomer = "SELECT * FROM tbl_customer WHERE id_customer = $id";

$result = mysqli_query($koneksi, $sqlCustomer);
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Data Customer</li>                        
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
