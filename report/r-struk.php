...
$nota = $_GET['nota'];
$dataJual = getDataBarang("SELECT * FROM tbl_jual_head WHERE no_jual = '$nota'")[0];
$itemJual = getDataBarang("SELECT * FROM tbl_jual_detail WHERE no_jual = '$nota'");
...
<body>
    ...
    <table style="border-bottom: dotted 2px;  font-size: 14px; width:240px;">
        ...
        <?php 
          ...
          <tr>
                ...
                <td colspan="2" style="width: 70px; text-align:right;"><?= number_format($item['jumlah_harga'],0,',','.') ?></td>
            </tr>
        <?php  }
        ?>
    ...
    <table style="text-align:center; margin: top 5px; font-size: 14px; width:240px;">
        <tr>
           <td>TERIMAKASIH SUDAH BERBELANJA DI <strong>HilmiPos</strong></td>
        </tr>
    </table>
